...
<script runat="server">
	...
	public void Page_Load()
	{
		...
		String strConexao = "Password=etesp; Persist Security Info=True; User ID=sa; Initial Catalog=quiz; Data Source=" + Environment.MachineName + "\\SQLEXPRESS";
		...
		String strSQL = "select P.pergunta, R.resposta, R.correta from tblResposta R inner join tblPergunta P on P.id = R.pergunta and R.pergunta =" + id;
...
;			//concatena += (ByteToHexString((Byte[])dr[3])) + ";";//campo fone do banco de dados
